# ServiceRegistry Docker Image

This Dockerfile builds a production-grade, minimal, and secure image for the ServiceRegistry microservice.

## Build

docker build -t service-registry:1.0.0 -f Dockerfiles/ServiceRegistry/Dockerfile .
